...
def register():
    ...
    Pool.register(
        ...
        # contacts.ImporterContactsStockView,
        # contacts.ImporterContactsStock,
        stock.Importer,
    ...
    Pool.register(
        ...
        module='importer', type_='model')
    Pool.register(
        # contacts.ImporterContactsInvoiceView,
        # contacts.ImporterContactsInvoice,
        invoice.Importer,
